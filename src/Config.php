...
use Aleris\Container\Exceptions\{ContainerFileNotExistsException, ContainerInvalidConfigException};

/**
 * Handles the configuration file for the Aleris container for all 
